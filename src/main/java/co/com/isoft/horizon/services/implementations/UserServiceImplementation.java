...
public class UserServiceImplementation implements UserService, UserDetailsService {
  ...
  public Role saveRole(Role role) throws DuplicateResourceException {
    ...
    if (roleRepo.existsByName(role.getName()))
      throw new DuplicateResourceException("The role name already exists");
        ...
        .orElseThrow(
            () ->
                new ResourceNotFoundException(
                    String.format("The user with the id %d doesn't exist", id)));
  }
  ...
  public User getUser(String email) throws ResourceNotFoundException {
    ...
    return userRepo
        ...
        .orElseThrow(
            () ->
                new ResourceNotFoundException(
                    String.format("The user with the email %s doesn't exist", email)));
  }
  ...
  public Role getRole(String name) throws ResourceNotFoundException {
    ...
    return roleRepo
        ...
        .orElseThrow(
            () ->
                new ResourceNotFoundException(
                    String.format("The role with the name %s doesn't exist", name)));
  }
}
